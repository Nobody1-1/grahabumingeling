...
import { ArrowLeft, Building, Upload, Save, X } from "lucide-react";
			...
			<div className="ml-64">
				<div className="p-8">
					<div className="mb-8">
						...
						<h1 className="text-3xl font-bold text-gray-900 dark:text-white">Tambah Tipe Rumah Baru</h1>
						<p className="text-gray-600 dark:text-gray-400">Tambahkan tipe rumah baru ke dalam sistem</p>
					</div>
						...
						<form onSubmit={onSubmit} className="p-8 space-y-6">
							<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
									...
									<div className="grid grid-cols-3 gap-4">
										...
										<div>
											...
											<input 
												...
												className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white" 
												value={park} 
												onChange={(e) => setPark(Number(e.target.value))} 
											/>
										</div>
									</div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                            Galeri Gambar (satu URL per baris)
                                        </label>
                                        <textarea
                                            rows={6}
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <label className="inline-flex items-center gap-2 text-sm">
                                            <input type="checkbox" checked={plafonPVC} onChange={(e) => setPlafonPVC(e.target.checked)} />
                                            Plafon PVC
                                        </label>
                                        <label className="inline-flex items-center gap-2 text-sm">
                                            <input type="checkbox" checked={aksesCorBeton} onChange={(e) => setAksesCorBeton(e.target.checked)} />
                                            Akses Cor Beton
                                        </label>
                                    </div>
							...
							<div className="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200 dark:border-gray-700">
								...
								>
									...
									{loading ? "Menyimpan..." : "Simpan Tipe Rumah"}
								</button>
							</div>
						</form>
					</div>
